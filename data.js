...
// DATA — the store
// ══════════════════════════════════════════════════════════════
// Every beer, brewery, location and brand domain lives in this file and
// nowhere else. app.js holds no data and this file holds no behaviour, so a
// review can be added without opening the rendering code, and the rendering
// code can be reworked without touching the reviews.
//
// Loaded before app.js by a plain <script> tag — there is no build step and
// no module system. `beers`, `breweries` and `drunkLocs` are `let` so a host
// that stores the data elsewhere can replace their contents and call
// reloadData() (app.js) to repaint.
//
// Adding a beer: see CLAUDE.md, then run `npm run check` — it verifies every
// invariant that file describes (country codes, brewery coverage, brand
// domains, style colours, consumption cities) before the site is opened.
// `npm run export` refreshes the JSON/CSV copies in data/.
// ══════════════════════════════════════════════════════════════
...
let beers=[
  ...
  {beer:"Michelob Ultra",  style:"Lager",           origin:"US",abv:4.2,method:"Can",   city:"White Plains",region:"New York",        country:"USA",         cc:"US", rating:2.50,isNew:false,month:"Jan",monthN:1,year:2026,logo:"logos/michelob-ultra.webp"},
  ...
  {beer:"Żywiec",         style:"Lager",                origin:"PL",abv:5.5,method:"Bottle",city:"New Rochelle",region:"New York",        country:"USA",         cc:"US", rating:2.75,isNew:true, month:"Mar",monthN:3,year:2026,logo:"logos/zywiec.webp"},
  ...
  {beer:"Pacífico Clara",   style:"Lager",              origin:"MX",abv:4.5,method:"Bottle",city:"Clemson",      region:"South Carolina",  country:"USA",         cc:"US", rating:3.75,isNew:true, month:"May",monthN:5,year:2026,logo:"logos/pacifico-clara.svg"},
  ...
  {beer:"Smithwick's",     style:"Red Ale",              origin:"IE",abv:4.5,method:"Draft", city:"White Plains",region:"New York",        country:"USA",         cc:"US", rating:2.75,isNew:true, month:"May",monthN:5,year:2026,logo:"logos/smithwicks.svg"},
  ...
  {beer:"Pub Ale",               style:"Pale Ale",             origin:"GB-ENG",abv:4.7,method:"Can",   city:"New Rochelle",region:"New York",        country:"USA",         cc:"US", rating:4.25,isNew:true, month:"Jul",monthN:7,year:2026,logo:"logos/pub-ale.svg"},
  ...
  {beer:"Killsner",              style:"Pilsner",        origin:"US",abv:5.0,method:"Can",   city:"New York",     region:"New York",        country:"USA",         cc:"US", rating:2.50,isNew:true, month:"Sep",monthN:9,year:2026},
];
...
let breweries=[
  ...
  {name:"Kills Boro Brewing Co.",    location:"Staten Island, New York",   country:"USA",         cc:"US", lang:"en", beers:"Killsner",                                     lat:40.6444,lng:-74.0989, ratings:[2.50]},
];
...
const WANT_TO_TRY=[
  ...
  // ── Britain and Ireland
  {beer:'Newcastle Brown Ale',   style:'Brown Ale',   origin:'GB-ENG', abv:4.7, region:'Tadcaster, Yorkshire',         untappd:3.28, method:'Bottle', logo:'logos/newcastle-brown-ale.webp'},
  ...
  {beer:'Sol',                   style:'Lager',       origin:'MX',     abv:4.5, region:'Mexico City',                  untappd:3.15, method:'Bottle', logo:'logos/sol.svg'},
  ...
  {beer:'Singha',                style:'Lager',       origin:'TH',     abv:5.0, region:'Bangkok',                      untappd:3.25, method:'Bottle', logo:'logos/singha.svg'},
